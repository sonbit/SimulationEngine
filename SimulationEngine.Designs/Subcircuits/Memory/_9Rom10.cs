...
public class _9Rom10 : Subcircuit
{
    ...
    public _9Rom10()
    {
        ...
        var _9Rom2_2 = this.AddSubcircuit(new _9Rom2());
        var _9Rom2_3 = this.AddSubcircuit(new _9Rom2());
        var _9Rom2_4 = this.AddSubcircuit(new _9Rom2());

        this.AddWires([
            (RdAddr1, _9Rom2_0.RdAddr1),
            (RdAddr0, _9Rom2_0.RdAddr0),
            (WrAddr1, _9Rom2_0.WrAddr1),
            (WrAddr0, _9Rom2_0.WrAddr0),
            (WrData9, _9Rom2_0.WrData1),
            (WrData8, _9Rom2_0.WrData0),
            (Clk, _9Rom2_0.Clk),

            (RdAddr1, _9Rom2_1.RdAddr1),
            (RdAddr0, _9Rom2_1.RdAddr0),
            (WrAddr1, _9Rom2_1.WrAddr1),
            (WrAddr0, _9Rom2_1.WrAddr0),
            (WrData7, _9Rom2_1.WrData1),
            (WrData6, _9Rom2_1.WrData0),
            (Clk, _9Rom2_1.Clk),

            (RdAddr1, _9Rom2_2.RdAddr1),
            (RdAddr0, _9Rom2_2.RdAddr0),
            (WrAddr1, _9Rom2_2.WrAddr1),
            (WrAddr0, _9Rom2_2.WrAddr0),
            (WrData5, _9Rom2_2.WrData1),
            (WrData4, _9Rom2_2.WrData0),
            (Clk, _9Rom2_2.Clk),

            (RdAddr1, _9Rom2_3.RdAddr1),
            (RdAddr0, _9Rom2_3.RdAddr0),
            (WrAddr1, _9Rom2_3.WrAddr1),
            (WrAddr0, _9Rom2_3.WrAddr0),
            (WrData3, _9Rom2_3.WrData1),
            (WrData2, _9Rom2_3.WrData0),
            (Clk, _9Rom2_3.Clk),

            (RdAddr1, _9Rom2_4.RdAddr1),
            (RdAddr0, _9Rom2_4.RdAddr0),
            (WrAddr1, _9Rom2_4.WrAddr1),
            (WrAddr0, _9Rom2_4.WrAddr0),
            (WrData1, _9Rom2_4.WrData1),
            (WrData0, _9Rom2_4.WrData0),
            (Clk, _9Rom2_4.Clk),
