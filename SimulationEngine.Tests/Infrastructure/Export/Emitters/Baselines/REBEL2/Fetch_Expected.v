...
module c_ProgCtr2 (
	...
	c_DLatchEdge c_DLatchEdge_0 (
		.Clk(Clk),
		.Din(tnet_2),
		.Dout(tnet_4)
	);

	c_DLatchEdge c_DLatchEdge_1 (
		.Clk(Clk),
		.Din(tnet_3),
		.Dout(tnet_5)
	);

	c_Increment2 c_Increment2_0 (
		.X1(tnet_4),
		.X0(tnet_5),
		.Q1(tnet_0),
		.Q0(tnet_1)
